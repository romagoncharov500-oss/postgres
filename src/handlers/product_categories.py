...
@command("list categories", "список всех категорий", CATEGORY_PRODUCT_CATEGORIES, ALL_ROLES)
...
@command("show category", "информация о складе", CATEGORY_PRODUCT_CATEGORIES, ALL_ROLES)
